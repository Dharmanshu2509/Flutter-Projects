...
class HomeScreenState extends State <HomeScreen> {
  ...
  bool isScrolled = false; // Define and initialize _isScrolled variable
  ScrollController _scrollController = ScrollController(); // Initialize _scrollController here
  ...
  Widget build(BuildContext context) {
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
      statusBarColor: isScrolled ? Colors.transparent.withOpacity(1) : Colors.transparent,
      statusBarIconBrightness: isScrolled ? Brightness.light : Brightness.dark,
      statusBarBrightness: isScrolled ? Brightness.light : Brightness.dark,
    ));
